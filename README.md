...
| [**Renovate Configuration and Health Check**](./docs/workflows/renovate-config-lint.md) | Validate Renovate configuration and report dependency health failures | On configuration changes, weekly schedule, manual trigger | [renovate-config-lint.yaml](./workflow-templates/renovate-config-lint.yaml) |
